...
const Navbar = ({ onOpen }) => {
    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            ...
            <button type='button' aria-label='Open navigation menu' onClick={onOpen} onMouseEnter={() => {
                navGreenRef.current.style.height = '100%'
            }}
                onMouseLeave={() => {
                    navGreenRef.current.style.height = '0%'
                }}
                className='z-50 lg:h-16 h-10 bg-black relative lg:w-[16vw] w-48 cursor-pointer'>
